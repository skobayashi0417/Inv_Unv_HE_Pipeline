...
def runPipeline(config):
    ...
    if config['mouseModelInference']['performInference'] == True:
        ...
        print('Performing LDA clinical score bin inference...')
        config['directories']['GEN_PATCHES_DIR'] = '/data09/shared/skobayashi/YANGPROSPECTIVE_fullPipeline_allMice/Involved_UninvolvedPatches'
        config['csInference']['onProspectiveCohort'] == True
